...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set NPwm_A [ create_bd_port -dir O NPwm_A ]
  set NPwm_B [ create_bd_port -dir O NPwm_B ]
  set NPwm_C [ create_bd_port -dir O NPwm_C ]
  set Pwm_A [ create_bd_port -dir O Pwm_A ]
  set Pwm_B [ create_bd_port -dir O Pwm_B ]
  set Pwm_C [ create_bd_port -dir O Pwm_C ]
  set refx [ create_bd_port -dir O refx ]

  # Create instance: Modulador_m_instant_0, and set properties
  set Modulador_m_instant_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Modulador_m_instant:1.0 Modulador_m_instant_0 ]

  # Create instance: Write_register_m_inst_0, and set properties
  set Write_register_m_inst_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Write_register_m_inst:1.0 Write_register_m_inst_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins Write_register_m_inst_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Modulador_m_instant_0_NPwm_A [get_bd_ports NPwm_A] [get_bd_pins Modulador_m_instant_0/NPwm_A]
  connect_bd_net -net Modulador_m_instant_0_NPwm_B [get_bd_ports NPwm_B] [get_bd_pins Modulador_m_instant_0/NPwm_B]
  connect_bd_net -net Modulador_m_instant_0_NPwm_C [get_bd_ports NPwm_C] [get_bd_pins Modulador_m_instant_0/NPwm_C]
  connect_bd_net -net Modulador_m_instant_0_Pwm_A [get_bd_ports Pwm_A] [get_bd_pins Modulador_m_instant_0/Pwm_A]
  connect_bd_net -net Modulador_m_instant_0_Pwm_B [get_bd_ports Pwm_B] [get_bd_pins Modulador_m_instant_0/Pwm_B]
  connect_bd_net -net Modulador_m_instant_0_Pwm_C [get_bd_ports Pwm_C] [get_bd_pins Modulador_m_instant_0/Pwm_C]
  connect_bd_net -net Modulador_m_instant_0_refx [get_bd_ports refx] [get_bd_pins Modulador_m_instant_0/refx]
  connect_bd_net -net Write_register_m_inst_0_Fsw [get_bd_pins Modulador_m_instant_0/Fsw2] [get_bd_pins Write_register_m_inst_0/Fsw]
  connect_bd_net -net Write_register_m_inst_0_ena [get_bd_pins Modulador_m_instant_0/ena] [get_bd_pins Write_register_m_inst_0/ena]
  connect_bd_net -net Write_register_m_inst_0_ma [get_bd_pins Modulador_m_instant_0/ma2] [get_bd_pins Write_register_m_inst_0/ma]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Write_register_m_inst_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Modulador_m_instant_0/Clk_inv] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins Write_register_m_inst_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Write_register_m_inst_0/S00_AXI/S00_AXI_reg] SEG_Write_register_m_inst_0_S00_AXI_reg
...
preplace port refx -pg 1 -y 140 -defaultsOSRD
preplace port NPwm_A -pg 1 -y 180 -defaultsOSRD
preplace port NPwm_B -pg 1 -y 220 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 90 -defaultsOSRD
preplace port NPwm_C -pg 1 -y 260 -defaultsOSRD
preplace port Pwm_A -pg 1 -y 160 -defaultsOSRD
preplace port Pwm_B -pg 1 -y 200 -defaultsOSRD
preplace port Pwm_C -pg 1 -y 240 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 370 -defaultsOSRD
preplace inst Modulador_m_instant_0 -pg 1 -lvl 3 -y 160 -defaultsOSRD
preplace inst Write_register_m_inst_0 -pg 1 -lvl 2 -y 190 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 3 -y -70 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 220 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 1 3 NJ 120 NJ 270 NJ
preplace netloc Modulador_m_instant_0_Pwm_B 1 3 1 1170
preplace netloc Modulador_m_instant_0_Pwm_C 1 3 1 1150
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 1 3 440 280 NJ 280 1130
preplace netloc Modulador_m_instant_0_refx 1 3 1 1210
preplace netloc processing_system7_0_M_AXI_GP0 1 1 2 400 -130 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 1 400
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 450 260 820
preplace netloc Write_register_m_inst_0_ena 1 2 1 830
preplace netloc Write_register_m_inst_0_ma 1 2 1 770
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 50 NJ 50 NJ
preplace netloc Modulador_m_instant_0_NPwm_A 1 3 1 1190
preplace netloc Write_register_m_inst_0_Fsw 1 2 1 810
preplace netloc Modulador_m_instant_0_NPwm_B 1 3 1 1160
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 1 780
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 370 420 -30 790
preplace netloc Modulador_m_instant_0_NPwm_C 1 3 1 1140
preplace netloc processing_system7_0_FCLK_CLK1 1 1 2 NJ 270 790
preplace netloc Modulador_m_instant_0_Pwm_A 1 3 1 1200
levelinfo -pg 1 0 210 610 980 1370 -top -180 -bot 480
",
}
