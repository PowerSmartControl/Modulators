...
rst -processor
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279759344A"} -index 0
dow C:/pruebas/Sepsa_full_bridge_comunicacion/IP_pspwm.sdk/Comunicacion1_bsp_xuartps_hello_world_example_1/Debug/Comunicacion1_bsp_xuartps_hello_world_example_1.elf
targets -set -nocase -filter {name =~ "ARM*#0" && jtag_cable_name =~ "Digilent Zybo 210279759344A"} -index 0
con
