...
################################################################
# This is a generated script based on design: Pspwm
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: Alto_nivel_0, and set properties
  set Alto_nivel_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:Alto_nivel:1.0 Alto_nivel_0 ]
...
CONFIG.NUM_MI {2} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins myip_pspwm_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Alto_nivel_0_Pwm1 [get_bd_ports Pwm1] [get_bd_pins Alto_nivel_0/Pwm1]
  connect_bd_net -net Alto_nivel_0_Pwm2 [get_bd_ports Pwm2] [get_bd_pins Alto_nivel_0/Pwm2]
  connect_bd_net -net Alto_nivel_0_Pwm3 [get_bd_ports Pwm3] [get_bd_pins Alto_nivel_0/Pwm3]
  connect_bd_net -net Alto_nivel_0_Pwm4 [get_bd_ports Pwm4] [get_bd_pins Alto_nivel_0/Pwm4]
  connect_bd_net -net Alto_nivel_0_reset [get_bd_ports reset] [get_bd_pins Alto_nivel_0/reset]
  connect_bd_net -net myip_pspwm_0_Ciclo_trabajo [get_bd_pins Alto_nivel_0/ciclo_trabajo] [get_bd_pins myip_pspwm_0/Ciclo_trabajo]
  connect_bd_net -net myip_pspwm_0_Frecuencia_conmutacion [get_bd_pins Alto_nivel_0/frecuencia_conmutacion] [get_bd_pins myip_pspwm_0/Frecuencia_conmutacion]
  connect_bd_net -net myip_pspwm_0_Tiempo_muerto1 [get_bd_pins Alto_nivel_0/deadtime1] [get_bd_pins myip_pspwm_0/Tiempo_muerto1]
  connect_bd_net -net myip_pspwm_0_Tiempo_muerto2 [get_bd_pins Alto_nivel_0/deadtime2] [get_bd_pins myip_pspwm_0/Tiempo_muerto2]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins myip_pspwm_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Alto_nivel_0/Clk_fpga] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins myip_pspwm_0/s00_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_pspwm_0/S00_AXI/S00_AXI_reg] SEG_myip_pspwm_0_S00_AXI_reg
...
preplace port Pwm1 -pg 1 -y 170 -defaultsOSRD
preplace port Pwm2 -pg 1 -y 190 -defaultsOSRD
preplace port Pwm3 -pg 1 -y 210 -defaultsOSRD
preplace port Pwm4 -pg 1 -y 230 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port reset -pg 1 -y 250 -defaultsOSRD
preplace inst Alto_nivel_0 -pg 1 -lvl 4 -y 210 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 390 -defaultsOSRD
preplace inst myip_pspwm_0 -pg 1 -lvl 3 -y 220 -defaultsOSRD
...
preplace netloc Alto_nivel_0_Pwm4 1 4 1 NJ
preplace netloc myip_pspwm_0_Tiempo_muerto1 1 3 1 N
preplace netloc myip_pspwm_0_Tiempo_muerto2 1 3 1 N
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc Alto_nivel_0_reset 1 4 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 440
preplace netloc myip_pspwm_0_Ciclo_trabajo 1 3 1 1080
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 300 410
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 440 360 750
preplace netloc myip_pspwm_0_Frecuencia_conmutacion 1 3 1 1070
preplace netloc processing_system7_0_FIXED_IO 1 1 4 NJ 60 NJ 60 NJ 60 NJ
preplace netloc Alto_nivel_0_Pwm1 1 4 1 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 420
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 290 430 350 740
preplace netloc processing_system7_0_FCLK_CLK1 1 1 3 NJ 70 NJ 70 1070
preplace netloc Alto_nivel_0_Pwm2 1 4 1 NJ
preplace netloc Alto_nivel_0_Pwm3 1 4 1 NJ
levelinfo -pg 1 0 220 590 910 1220 1380 -top 0 -bot 480
",
}
