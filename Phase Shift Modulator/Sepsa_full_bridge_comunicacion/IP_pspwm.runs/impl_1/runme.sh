...
HD_PWD='C:/pruebas/Sepsa_full_bridge_comunicacion/IP_pspwm.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Pspwm_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source Pspwm_wrapper.tcl -notrace
