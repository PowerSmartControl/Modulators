...
HD_PWD='C:/pruebas/Sepsa_full_bridge_comunicacion/IP_pspwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Pspwm_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Pspwm_wrapper.tcl
